...
export const removeLoginError = (param) => (dispatch) => {
  dispatch({ type: REMOVE_LOGIN_ERROR, payload: param })
}

export const setRegistrationErrors = (errors) => (dispatch) => {
  dispatch({ type: SET_REGISTRATION_ERRORS, payload: errors })
}

export const removeRegistrationError = (param) => (dispatch) => {
  dispatch({ type: REMOVE_REGISTRATION_ERROR, payload: param })
}
